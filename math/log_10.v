...
//altfp_log CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" PIPELINE=21 WIDTH_EXP=8 WIDTH_MAN=23 clock data result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" PIPELINE=1 SHIFTDIR="LEFT" WIDTH=32 WIDTHDIST=5 aclr clk_en clock data distance result
...
module  log_10_altbarrel_shift_e0e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //log_10_altbarrel_shift_e0e


//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" SHIFTDIR="LEFT" WIDTH=64 WIDTHDIST=6 data distance result
//VERSION_BEGIN 13.0 cbx_altbarrel_shift 2013:06:12:18:03:43:SJ cbx_mgl 2013:06:12:18:05:10:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altbarrel_shift_mdb
	( 
	data,
	distance,
	result) ;
...
endmodule //log_10_altbarrel_shift_mdb


//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" PIPELINE=1 SHIFTDIR="RIGHT" WIDTH=32 WIDTHDIST=5 aclr clk_en clock data distance result
//VERSION_BEGIN 13.0 cbx_altbarrel_shift 2013:06:12:18:03:43:SJ cbx_mgl 2013:06:12:18:05:10:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altbarrel_shift_14e
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({32{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[143:128], pad_w[15:0]}) | ({32{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[159:144]})) | ({32{(~ sel_w[4])}} & sbit_w[159:128])), ((({32{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[119:96], pad_w[7:0]}) | ({32{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[127:104]})) | ({32{(~ sel_w[3])}} & sbit_w[127:96])), ((({32{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[91:64], pad_w[3:0]}) | ({32{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[95:68]})) | ({32{(~ sel_w[2])}} & sbit_w[95:64])), ((({32{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[61:32], pad_w[1:0]}) | ({32{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[63:34]})) | ({32{(~ sel_w[1])}} & sbit_w[63:32])), ((({32{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[30:0], pad_w[0]}) | ({32{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[31:1]})) | ({32{(~ sel_w[0])}} & sbit_w[31:0]))};
endmodule //log_10_altbarrel_shift_14e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_and_or_f9b
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_10_altfp_log_and_or_f9b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_and_or_t6b
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		...
		operation_r2_w = {(operation_r2_w[0] | connection_r1_w[1]), connection_r1_w[0]},
		result = connection_dffe2;
endmodule //log_10_altfp_log_and_or_t6b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_and_or_a8b
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_10_altfp_log_and_or_a8b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_s0e
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_10_altfp_log_csa_s0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_k0e
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_10_altfp_log_csa_k0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_0nc
	( 
	dataa,
	datab,
	result) ;
...
endmodule //log_10_altfp_log_csa_0nc
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_d4b
	( 
	dataa,
	datab,
	result) ;
...
endmodule //log_10_altfp_log_csa_d4b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_umc
	( 
	dataa,
	datab,
	result) ;
...
endmodule //log_10_altfp_log_csa_umc
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_nlf
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_10_altfp_log_csa_nlf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_8kf
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_10_altfp_log_csa_8kf


//altfp_log_rr_block CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" WIDTH_ALMOSTLOG=39 WIDTH_Y0=25 WIDTH_Z=26 a0_in aclr almostlog clk_en clock y0_in z
//VERSION_BEGIN 13.0 cbx_altbarrel_shift 2013:06:12:18:03:43:SJ cbx_altfp_log 2013:06:12:18:03:43:SJ cbx_altpriority_encoder 2013:06:12:18:03:43:SJ cbx_altsquare 2013:06:12:18:03:43:SJ cbx_cycloneii 2013:06:12:18:03:43:SJ cbx_lpm_add_sub 2013:06:12:18:03:43:SJ cbx_lpm_compare 2013:06:12:18:03:43:SJ cbx_lpm_mult 2013:06:12:18:03:43:SJ cbx_lpm_mux 2013:06:12:18:03:43:SJ cbx_mgl 2013:06:12:18:05:10:SJ cbx_padd 2013:06:12:18:03:43:SJ cbx_stratix 2013:06:12:18:03:43:SJ cbx_stratixii 2013:06:12:18:03:43:SJ cbx_util_mgl 2013:06:12:18:03:43:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_r0e
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_10_altfp_log_csa_r0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_o0e
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_10_altfp_log_csa_o0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_l1e
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		result = result_w,
		result_w = {(({15{(~ wire_csa_lower_cout)}} & wire_csa_upper0_result) | ({15{wire_csa_lower_cout}} & wire_csa_upper1_result)), wire_csa_lower_result};
endmodule //log_10_altfp_log_csa_l1e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_s1e
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		result = result_w,
		result_w = {(({14{(~ wire_csa_lower_cout)}} & wire_csa_upper0_result) | ({14{wire_csa_lower_cout}} & wire_csa_upper1_result)), wire_csa_lower_result};
endmodule //log_10_altfp_log_csa_s1e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altfp_log_csa_p1e
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		result = result_w,
		result_w = {(({13{(~ wire_csa_lower_cout)}} & wire_csa_upper0_result) | ({13{wire_csa_lower_cout}} & wire_csa_upper1_result)), wire_csa_lower_result};
endmodule //log_10_altfp_log_csa_p1e

//synthesis_resources = lpm_add_sub 27 lpm_mult 4 lpm_mux 5 reg 531 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_range_reduction_qtd
	( 
	a0_in,
	aclr,
	almostlog,
...
`endif
	...
	log_10_altfp_log_csa_s0e   add0_1
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_csa_s0e   add0_2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_csa_s0e   add0_3
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_csa_k0e   add1_1
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_csa_r0e   add1_2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_csa_o0e   add1_3
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_csa_l1e   sub1_1
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_csa_s1e   sub1_2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_csa_p1e   sub1_3
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
...
endmodule //log_10_range_reduction_qtd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //log_10_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //log_10_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	log_10_altpriority_encoder_3v7   altpriority_encoder14
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder14_q));
	log_10_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[3:2]),
...
endmodule //log_10_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	log_10_altpriority_encoder_3e8   altpriority_encoder16
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	log_10_altpriority_encoder_3e8   altpriority_encoder17
	( 
	.data(data[3:2]),
...
endmodule //log_10_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	log_10_altpriority_encoder_6v7   altpriority_encoder12
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder12_q));
	log_10_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[7:4]),
...
endmodule //log_10_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	log_10_altpriority_encoder_6e8   altpriority_encoder18
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	log_10_altpriority_encoder_6e8   altpriority_encoder19
	( 
	.data(data[7:4]),
...
endmodule //log_10_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	log_10_altpriority_encoder_bv7   altpriority_encoder10
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder10_q));
	log_10_altpriority_encoder_be8   altpriority_encoder11
	( 
	.data(data[15:8]),
...
endmodule //log_10_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	log_10_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder20_q),
	.zero(wire_altpriority_encoder20_zero));
	log_10_altpriority_encoder_be8   altpriority_encoder21
	( 
	.data(data[15:8]),
...
endmodule //log_10_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_tv8
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	log_10_altpriority_encoder_r08   altpriority_encoder8
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder8_q));
	log_10_altpriority_encoder_rf8   altpriority_encoder9
	( 
	.data(data[31:16]),
...
endmodule //log_10_altpriority_encoder_tv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_te9
	( 
	data,
	q,
	zero) ;
	...
	log_10_altpriority_encoder_rf8   altpriority_encoder22
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	log_10_altpriority_encoder_rf8   altpriority_encoder23
	( 
	.data(data[31:16]),
...
endmodule //log_10_altpriority_encoder_te9

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_uja
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	log_10_altpriority_encoder_tv8   altpriority_encoder6
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder6_q));
	log_10_altpriority_encoder_te9   altpriority_encoder7
	( 
	.data(data[63:32]),
...
endmodule //log_10_altpriority_encoder_uja
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_10_altpriority_encoder_q08
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	log_10_altpriority_encoder_r08   altpriority_encoder24
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder24_q));
	log_10_altpriority_encoder_rf8   altpriority_encoder25
	( 
	.data(data[31:16]),
...
module  log_10_altfp_log_mfa
	...
	log_10_altbarrel_shift_e0e   Lshiftsmall
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_and_or_f9b   exp_nan
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_and_or_t6b   exp_zero
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_and_or_a8b   man_inf
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_and_or_a8b   man_nan
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_csa_0nc   exp_biase_sub
	( 
	.dataa(exp_data),
	.datab(exp_biase),
	.result(wire_exp_biase_sub_result));
	log_10_altfp_log_csa_d4b   sub1
	( 
	.dataa({12{1'b0}}),
	.datab(Y0[11:0]),
	.result(wire_sub1_result));
	log_10_altfp_log_csa_0nc   sub2
	( 
	.dataa({8{1'b0}}),
	.datab(E0),
	.result(wire_sub2_result));
	log_10_altfp_log_csa_umc   sub3
	( 
	.dataa({1'b0, lzo}),
	.datab({1'b0, pfinal_s}),
	.result(wire_sub3_result));
	log_10_altfp_log_csa_nlf   sub4
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_10_altfp_log_csa_0nc   sub6
	( 
	.dataa(E0offset),
	.datab({{3{1'b0}}, (~ E_normal)}),
	.result(wire_sub6_result));
	log_10_range_reduction_qtd   range_reduction
	( 
	...
	log_10_altpriority_encoder_uja   lzc_norm_E
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	.q(wire_lzc_norm_E_q));
	log_10_altpriority_encoder_q08   lzoc
	( 
...
endmodule //log_10_altfp_log_mfa
//VALID FILE
...
module log_10 (
	...
	log_10_altfp_log_mfa	log_10_altfp_log_mfa_component (
				.clock (clock),
				.data (data),
				.result (sub_wire0));
