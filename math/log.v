...
module  log_altbarrel_shift_e0e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //log_altbarrel_shift_e0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altbarrel_shift_mdb
	( 
	data,
	distance,
	result) ;
...
endmodule //log_altbarrel_shift_mdb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altbarrel_shift_14e
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({32{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[143:128], pad_w[15:0]}) | ({32{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[159:144]})) | ({32{(~ sel_w[4])}} & sbit_w[159:128])), ((({32{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[119:96], pad_w[7:0]}) | ({32{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[127:104]})) | ({32{(~ sel_w[3])}} & sbit_w[127:96])), ((({32{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[91:64], pad_w[3:0]}) | ({32{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[95:68]})) | ({32{(~ sel_w[2])}} & sbit_w[95:64])), ((({32{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[61:32], pad_w[1:0]}) | ({32{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[63:34]})) | ({32{(~ sel_w[1])}} & sbit_w[63:32])), ((({32{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[30:0], pad_w[0]}) | ({32{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[31:1]})) | ({32{(~ sel_w[0])}} & sbit_w[31:0]))};
endmodule //log_altbarrel_shift_14e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altfp_log_and_or_f9b
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_altfp_log_and_or_f9b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altfp_log_and_or_t6b
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	assign
		...
		operation_r2_w = {(operation_r2_w[0] | connection_r1_w[1]), connection_r1_w[0]},
		result = connection_dffe2;
endmodule //log_altfp_log_and_or_t6b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altfp_log_and_or_a8b
	( 
	aclr,
	clken,
	clock,
...
endmodule //log_altfp_log_and_or_a8b
...
endmodule //log_altfp_log_csa_s0e
...
endmodule //log_altfp_log_csa_k0e
...
endmodule //log_altfp_log_csa_0nc
...
endmodule //log_altfp_log_csa_d4b
...
endmodule //log_altfp_log_csa_umc
...
endmodule //log_altfp_log_csa_nlf
...
endmodule //log_altfp_log_csa_8kf
...
endmodule //log_altfp_log_csa_r0e
...
endmodule //log_altfp_log_csa_o0e
...
`endif
	...
	assign
		result = result_w,
		result_w = {(({15{(~ wire_csa_lower_cout)}} & wire_csa_upper0_result) | ({15{wire_csa_lower_cout}} & wire_csa_upper1_result)), wire_csa_lower_result};
endmodule //log_altfp_log_csa_l1e
...
`endif
	...
	assign
		result = result_w,
		result_w = {(({14{(~ wire_csa_lower_cout)}} & wire_csa_upper0_result) | ({14{wire_csa_lower_cout}} & wire_csa_upper1_result)), wire_csa_lower_result};
endmodule //log_altfp_log_csa_s1e
...
endmodule //log_range_reduction_qtd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //log_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //log_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	log_altpriority_encoder_3v7   altpriority_encoder14
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder14_q));
	log_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[3:2]),
...
endmodule //log_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	log_altpriority_encoder_3e8   altpriority_encoder16
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	log_altpriority_encoder_3e8   altpriority_encoder17
	( 
	.data(data[3:2]),
...
endmodule //log_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	log_altpriority_encoder_6v7   altpriority_encoder12
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder12_q));
	log_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[7:4]),
...
endmodule //log_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	log_altpriority_encoder_6e8   altpriority_encoder18
	( 
	.data(data[3:0]),
...
endmodule //log_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	log_altpriority_encoder_bv7   altpriority_encoder10
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder10_q));
	log_altpriority_encoder_be8   altpriority_encoder11
	( 
	.data(data[15:8]),
...
endmodule //log_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	log_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder20_q),
	.zero(wire_altpriority_encoder20_zero));
	log_altpriority_encoder_be8   altpriority_encoder21
	( 
	.data(data[15:8]),
...
endmodule //log_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_tv8
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	log_altpriority_encoder_r08   altpriority_encoder8
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder8_q));
	log_altpriority_encoder_rf8   altpriority_encoder9
	( 
	.data(data[31:16]),
...
endmodule //log_altpriority_encoder_tv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_te9
	( 
	data,
	q,
	zero) ;
	...
	log_altpriority_encoder_rf8   altpriority_encoder22
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	log_altpriority_encoder_rf8   altpriority_encoder23
	( 
	.data(data[31:16]),
...
endmodule //log_altpriority_encoder_te9

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_uja
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	log_altpriority_encoder_tv8   altpriority_encoder6
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder6_q));
	log_altpriority_encoder_te9   altpriority_encoder7
	( 
	.data(data[63:32]),
...
endmodule //log_altpriority_encoder_uja
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  log_altpriority_encoder_q08
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	log_altpriority_encoder_r08   altpriority_encoder24
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder24_q));
	log_altpriority_encoder_rf8   altpriority_encoder25
	( 
	.data(data[31:16]),
...
module  log_altfp_log_mfa
	...
	log_altbarrel_shift_e0e   Lshiftsmall
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	log_altfp_log_and_or_f9b   exp_nan
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_altfp_log_and_or_t6b   exp_zero
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_altfp_log_and_or_a8b   man_inf
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_altfp_log_and_or_a8b   man_nan
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_altfp_log_csa_0nc   exp_biase_sub
	( 
	.dataa(exp_data),
	.datab(exp_biase),
	.result(wire_exp_biase_sub_result));
	log_altfp_log_csa_d4b   sub1
	( 
	.dataa({12{1'b0}}),
	.datab(Y0[11:0]),
	.result(wire_sub1_result));
	log_altfp_log_csa_0nc   sub2
	( 
	.dataa({8{1'b0}}),
	.datab(E0),
	.result(wire_sub2_result));
	log_altfp_log_csa_umc   sub3
	( 
	.dataa({1'b0, lzo}),
	.datab({1'b0, pfinal_s}),
	.result(wire_sub3_result));
	log_altfp_log_csa_nlf   sub4
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	log_altfp_log_csa_0nc   sub6
	( 
	.dataa(E0offset),
	.datab({{3{1'b0}}, (~ E_normal)}),
	.result(wire_sub6_result));
	log_range_reduction_qtd   range_reduction
	( 
	...
	log_altpriority_encoder_uja   lzc_norm_E
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	.q(wire_lzc_norm_E_q));
	log_altpriority_encoder_q08   lzoc
	( 
...
module log (
	...
	log_altfp_log_mfa	log_altfp_log_mfa_component (
				.clock (clock),
				.data (data),
				.result (sub_wire0));
